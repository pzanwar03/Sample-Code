...
const PuppyDetailsModal: React.FunctionComponent<any> = (props) => {
        ...
        <ModelInfo>
          <Row>
            <Col md={7}>
              ...
              <Opensea
                onClick={() => {
                  window.open(`https://opensea.io/assets/${process.env.REACT_APP_CONTRACT_PUPPY_POUND}/${galleryDetails.tokenId}`, '_blank');
                }}
              >
                view on opensea
              </Opensea>
...
export default PuppyDetailsModal;
